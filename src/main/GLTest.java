 ...
 * @since 26 Feb 2009
 */
public class GLTest extends GLCanvas implements GLEventListener {
     ...
     */
    public GLTest(GLCapabilities capabilities, int width, int height) {
    ...
    public static void main(String[] args) {
        ...
        GLTest canvas = new GLTest(capabilities, 800, 500);
